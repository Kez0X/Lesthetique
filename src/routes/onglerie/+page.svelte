...
<script>
    ...
    let prestations = [
        { name: "Pose de vernis semi-permanent", time: "≈ 1h30", price: "40€", description: "Cuticules, limage, pose de vernis, huile de fin de soin" },
        { name: "Dépose & semi permanent", time: "≈ 2h", price: "45€", description: "" },
