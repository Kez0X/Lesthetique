...
<script>
    ...
    let prestations = [
        ...
        { name: "Drainage", time: "1h", price: "50€" },
...
<div class="soins-corps-page">
    <div class="header-section" style="background-image: url({SoinsCorpsImage})">
        <div class="overlay"></div>
        <h1>Prestations Soins du Corps</h1>
    </div>
